 ...
 * </p>
 * <ul>
 *   <li>{@link workflow.Workflow#getInformationObjects <em>Information Objects</em>}</li>
 *   <li>{@link workflow.Workflow#getActivities <em>Activities</em>}</li>
 * </ul>
 *
...
public interface Workflow extends EObject {
	 ...
	 * @see workflow.WorkflowPackage#getWorkflow_InformationObjects()
	 ...
	 * @see workflow.WorkflowPackage#getWorkflow_Activities()
	 * @model containment="true"
	 * @generated
	 */
