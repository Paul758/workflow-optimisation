 ...
 * </p>
 * <ul>
 *   <li>{@link model.workflow.Task#getAlternativePaths <em>Alternative Paths</em>}</li>
 * </ul>
 *
...
public interface Task extends InformationObject {
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Alternative Paths</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Alternative Paths</em>' containment reference list.
	 * @see model.workflow.WorkflowPackage#getTask_AlternativePaths()
